...
@Component
public class RepositoryInfoTool implements McpTool {

    private static final ToolDefinition DEFINITION = new ToolDefinition(
            McpConstants.REPOSITORY_INFO_TOOL,
            "Returns metadata for a GitHub repository.",
            Map.of(
                    "type", "object",
                    "properties", Map.of(
                            REPOSITORY_OWNER, Map.of(
                                    "type", "string", "description", "Repository owner"
                            ),
                            REPOSITORY_NAME, Map.of(
                                    "type", "string", "description", "Repository name"
                            )
                    ),
    ...
    public RepositoryInfoTool(GitHubService gitHubService) {
